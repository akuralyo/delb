...
import static com.kreative.delb.application.common.ApiRestPathVariable.PV_ID;
...
public interface ApiRestRessource<T> {
  ...
  @GetMapping(
      ...
      params = {"filterList"})
  ResponseEntity<List<HashMap<String, Object>>> findAllAndFilterAplly(
  ...
  @GetMapping(
      ...
      produces = APPLICATION_JSON_VALUE,
      params = {"filterList"})
  ResponseEntity<HashMap<String, Object>> findOneByIdAndFilterApply(
      @PathVariable String id, @RequestParam List<String> filterList);
